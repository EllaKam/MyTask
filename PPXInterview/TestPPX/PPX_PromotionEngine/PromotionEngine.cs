...
namespace PPX_PromotionEngine
{
    ...
    public class PromotionEngine
    {
        ...
        public void Init()
        {
            ...
            PromotionProvider providerVisa = new PromotionProvider(new VisaPromotionEngine());
            PromotionProvider providerLoyalty = new PromotionProvider(new LoyaltyPromotionEngine());
            promotionManager.AddProvider(providerVisa);
            promotionManager.AddProvider(providerLoyalty);
        }
        /// <summary>
